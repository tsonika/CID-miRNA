...
//   cout<<"\n\n"<<miRNAstruct<<"\n\n";
           ...
           *outfile<<"SCORE: ";
           ...
           structscore = (structstats.n_base_pairs*2)/(structstats.n_bases-(structstats.n_base_pairs*2));

/*           structscore  = 5*((structstats.n_base_pairs*2)/structstats.n_stems);
           structscore += (-2)*((structstats.n_bases - structstats.n_base_pairs*2 - structstats.n_loop_bases)/(structstats.n_asyms+structstats.n_asyms));
           structscore += structstats.n_loop_bases;*/
